            ...
            <div class="form-container">
                ...
                @if (session('success'))
                    <div class="alert alert-success alert-dismissible fade show p-2 small" role="alert">
                        {{ session('success') }}
                        <button type="button" class="btn-close p-2 mt-1 btn-sm" data-bs-dismiss="alert"
                ...
                <div class="table-responsive" style="max-width: 100%; overflow-x: auto;">
                    <table class="table table-striped table-hover table-bordered mt-3">
                        ...
                        <tbody>
                            @foreach ($beritas as $berita)
                                <tr>
                                    ...
                                    <td title="{{ $berita->title }}">
                                        {{ Str::limit($berita->title, 25, '...') }}
                                    </td>
                                    <td title="{{ $berita->content }}">
                                        {{ Str::limit($berita->content, 15, '...') }}
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex flex-column gap-2" style="min-width: 100px;">
                                            ...
                                            <form action="{{ route('news.destroy', $berita->id) }}" method="POST"
                                                class="w-100">
                                                @csrf
                                                @method('DELETE')
                        ...
                        @foreach ($beritas as $berita)
                            <div class="modal fade" id="viewModal{{ $berita->id }}" tabindex="-1"
                                aria-labelledby="viewModalLabel{{ $berita->id }}" aria-hidden="true">
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="viewModalLabel{{ $berita->id }}">Detail
                                                Berita</h5>
                                        ...
                                        <div class="modal-body">
                                            @if ($berita->image)
                                                <div class="text-center mb-4">
                                                    <img src="{{ asset('storage/' . $berita->image) }}"
                                                        alt="Image" class="img-fluid mt-3"
                                            ...
                                            @endif
                                            <h5 class="mb-4"><strong>Judul:</strong> {{ $berita->title }}</h5>
                                            <h5 class="mb-4"><strong>Konten:</strong> {{ $berita->content }}</h5>
                                        </div>
                                    </div>
                                </div>
                            </div>
