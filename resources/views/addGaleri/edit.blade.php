    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="container">
            <div class="form-container">
                <h2 class="fw-bold">Edit Galeri</h2>
                ...
                <form action="{{ route('galeri.update', $galeri->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @if ($galeri->image_path)
                            <div class="mb-2">
                                <img src="{{ asset('storage/' . $galeri->image_path) }}" alt="Preview"
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="status" name="status" required>
                            <option value="active" {{ $galeri->status == 'active' ? 'selected' : '' }}>Aktif</option>
                            <option value="inactive" {{ $galeri->status == 'inactive' ? 'selected' : '' }}>Nonaktif
                            </option>
                        </select>
                    </div>
