...
<body id="page-top">
    ...
    <div class="main-content" id="mainContent">
        ...
        <!-- Tabel Galeri -->
        <div class="container">
            <h2 class="fw-bold">Detail Galeri</h2>
            <div class="card">
                <img src="{{ asset('storage/' . $galeri->image_path) }}" class="card-img-top"
                    alt="{{ $galeri->title }}" style="max-width: 300px; height: auto; margin: 0 auto; display: block;">
                <div class="card-body">
                    <h5 class="card-title">{{ $galeri->title }}</h5>
                    <p class="card-text"><strong>Status:</strong> {{ ucfirst($galeri->status) }}</p>
