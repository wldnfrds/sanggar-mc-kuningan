    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="container">
            <div class="form-container">
                <h1>Tambah MC</h1>
                <form action="{{ route('mc.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="media_sosial" class="form-control" required>
                    </div>
                    <div class="mb-3">
                        <label for="foto" class="form-label">Foto Profile</label>
                        <input type="file" name="foto" class="form-control">
                    </div>
                    <button type="submit" class="btn btn-primary btn-sm mb-3 d-inline-flex align-items-center gap-2"
